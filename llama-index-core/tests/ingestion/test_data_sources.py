...
def test_can_generate_schema_for_data_source_component_type(
    ...
    schema = configurable_data_source_type.value.schema(ref_template='#/$defs/{model}')  # type: ignore
    ...
    configured_schema = ConfiguredDataSource[component_type].schema(ref_template='#/$defs/{model}')  # type: ignore
