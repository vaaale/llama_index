...
def pydantic_to_guidance_output_template(cls: Type[BaseModel]) -> str:
    ...
    return json_schema_to_guidance_output_template(cls.schema(ref_template='#/$defs/{model}'), root=cls.schema(ref_template='#/$defs/{model}'))
...
def pydantic_to_guidance_output_template_markdown(cls: Type[BaseModel]) -> str:
    ...
    output = json_schema_to_guidance_output_template(cls.schema(ref_template='#/$defs/{model}'), root=cls.schema(ref_template='#/$defs/{model}'))
